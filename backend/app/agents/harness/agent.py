...
async def run_harness(request: str, facts: Any, model: BaseChatModel) -> str:
    """
    ...
    for task in state.tasks:
        ...
        if refusal:
            ...
            # This is where we will dispatch to agents/tools/
            mock_claim = {
            ...
            obs = AgentObservation(task_id=task.task_id, status="VALID", claim=mock_claim)
            state.observations.append(obs)
